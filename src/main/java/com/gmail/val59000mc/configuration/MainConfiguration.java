...
public class MainConfiguration {
	...
	public MainConfiguration(GameManager gameManager) { this.gameManager = gameManager; }
	...
	public void load(YamlFile cfg, @Nullable YamlFile storage) {
		...
		regenHeadDropOnPlayerDeath = cfg.getBoolean("customize-game-behavior.add-regen-head-drop-on-player-death",
				true);
		...
		forceAssignSoloPlayerToTeamWhenStarting = cfg.getBoolean("force-assign-solo-player-to-team-when-starting",
				false);
		...
		serverName = cfg.getString("server-name", "solo");
		...
		// Set remaining time
		if (enableTimeLimit) { gameManager.setRemainingTime(timeLimit); }
		...
		for (String potionStr : potionStrList) {
			try {
				...
				Bukkit.getLogger().warning("[UhcCore] " + potionStr
						+ " ignored, please check the syntax. It must be formated like POTION_NAME/duration/amplifier");
			}
		}
		...
		if (allBlockLootsSection != null) {
			for (String blockLootSectionName : allBlockLootsSection.getKeys(false)) {
				ConfigurationSection blockLootSection = allBlockLootsSection
						.getConfigurationSection(blockLootSectionName);
		...
		if (!timeCommands.isEmpty()) {
			for (int i = 0; i < timeCommands.size(); i++) {
				...
				if (cmd.startsWith("/")) { timeCommands.set(i, cmd.substring(1)); }
			}
		}
		...
		if (!killCommands.isEmpty()) {
			for (int i = 0; i < killCommands.size(); i++) {
				...
				if (cmd.startsWith("/")) { killCommands.set(i, cmd.substring(1)); }
			}
		}
		...
		if (!winCommands.isEmpty()) {
			for (int i = 0; i < winCommands.size(); i++) {
				...
				if (cmd.startsWith("/")) { winCommands.set(i, cmd.substring(1)); }
			}
		}
	...
	public void loadVault() {
		...
		if (vault == null || !vault.getClass().getName().equals("net.milkbowl.vault.Vault")) {
			Bukkit.getLogger()
					.warning("[UhcCore] Vault plugin not found, there will be no support of economy rewards.");
			vaultLoaded = false;
		} else {
	...
	public boolean getForceAssignSoloPlayerToTeamWhenStarting() { return forceAssignSoloPlayerToTeamWhenStarting; }

	public int getTimeBeforeSendBungeeAfterDeath() { return timeBeforeSendBungeeAfterDeath; }

	public int getTimeBeforeSendBungeeAfterEnd() { return timeBeforeSendBungeeAfterEnd; }

	public boolean getEnableTimeEvent() { return enableTimeEvent; }

	public double getRewardTimeEvent() { return rewardTimeEvent; }

	public long getIntervalTimeEvent() { return intervalTimeEvent; }

	public boolean getEnableKillEvent() { return enableKillEvent; }

	public double getRewardKillEvent() { return rewardKillEvent; }

	public boolean getEnableWinEvent() { return enableWinEvent; }

	public double getRewardWinEnvent() { return rewardWinEnvent; }

	public int getNetherPasteAtY() { return netherPasteAtY; }

	public int getArenaPasteAtY() { return arenaPasteAtY; }

	public boolean getWorldEditLoaded() { return worldEditLoaded; }

	public boolean getVaultLoaded() { return vaultLoaded; }

	public boolean getProtocolLibLoaded() { return protocolLibLoaded; }

	public void setProtocolLibLoaded(boolean b) { protocolLibLoaded = b; }

	public int getMinPlayersToStart() { return minPlayersToStart; }

	public boolean getEnableGenerateVein() { return enableGenerateVein; }

	public boolean getEnableBlockLoots() { return enableBlockLoots; }

	public boolean getEnableMobLoots() { return enableMobLoots; }

	public int getRestEveryTicks() { return restEveryTicks; }

	public int getChunksPerTick() { return chunksPerTick; }

	public int getRestDuraton() { return restDuraton; }

	public boolean getEnablePregenerateWorld() { return enablePregenerateWorld; }

	public Map<Material, GenerateVeinConfiguration> getGenerateVeins() { return generateVeins; }

	public Map<Material, BlockLootConfiguration> getBlockLoots() { return blockLoots; }

	public Map<EntityType, MobLootConfiguration> getMobLoots() { return mobLoots; }

	public boolean getEnableFinalHeal() { return enableFinalHeal; }

	public long getFinalHealDelay() { return finalHealDelay; }

	public boolean getEnableUndergroundNether() { return enableUndergroundNether; }

	public int getMinOccurrencesUndergroundNether() { return minOccurrencesUndergroundNether; }

	public int getMaxOccurrencesUndergroundNether() { return maxOccurrencesUndergroundNether; }

	public boolean getEnableGenerateSugarcane() { return enableGenerateSugarcane; }

	public int getGenerateSugarcanePercentage() { return generateSugarcanePercentage; }

	public double getAppleDropPercentage() { return appleDropPercentage; }

	public boolean getAppleDropsFromAllTrees() { return appleDropsFromAllTrees; }

	public boolean getAppleDropsFromShearing() { return appleDropsFromShearing; }

	public boolean getReplaceOceanBiomes() { return replaceOceanBiomes; }

	public boolean getCaveOresOnly() { return caveOresOnly; }

	public Map<Material, GenerateVeinConfiguration> getMoreOres() { return generateVeins; }

	public boolean getDebug() { return debug; }

	public boolean getOnePlayerMode() { return onePlayerMode; }

	public boolean getEnableAutoUpdate() { return autoUpdate; }

	public boolean getEndGameWhenAllPlayersHaveLeft() { return endGameWhenAllPlayersHaveLeft; }

	public boolean getCanJoinAsSpectator() { return canJoinAsSpectator; }

	public List<PotionEffect> getPotionEffectOnStart() { return potionEffectOnStart; }

	public long getTimeBeforeRestartAfterEnd() { return timeBeforeRestartAfterEnd; }

	public boolean getTeamAlwaysReady() { return teamAlwaysReady; }

	public boolean getEnableTeamNames() { return enableTeamNames; }

	public boolean getAutoAssignNewPlayerTeam() { return autoAssignNewPlayerTeam; }

	public boolean getPreventPlayerFromLeavingTeam() { return preventPlayerFromLeavingTeam; }

	public int getMinimalReadyTeamsPercentageToStart() { return minimalReadyTeamsPercentageToStart; }

	public boolean getPickRandomSeedFromList() { return pickRandomSeedFromList; }

	public List<Long> getSeeds() { return seeds; }

	public String getOverworldUuid() { return overworldUuid; }

	public String getNetherUuid() { return netherUuid; }

	public String getTheEndUuid() { return theEndUuid; }

	public boolean getEnablePlayingCompass() { return enablePlayingCompass; }

	public int getPlayingCompassMode() { return playingCompassMode; }

	public int getPlayingCompassCooldown() { return playingCompassCooldown; }

	public boolean getHeartsOnTab() { return heartsOnTab; }

	public boolean getHeartsBelowName() { return heartsBelowName; }

	public boolean getSpectatingTeleport() { return spectatingTeleport; }

	public int getTimeBeforePvp() { return timeBeforePvp; }

	public boolean getEnableFriendlyFire() { return enableFriendlyFire; }

	public boolean getDisableEnemyNametags() { return disableEnemyNametags; }

	public boolean getCanSpectateAfterDeath() { return canSpectateAfterDeath; }

	public boolean getCanSendMessagesAfterDeath() { return canSendMessagesAfterDeath; }

	public boolean getEnableChatPrefix() { return enableChatPrefix; }

	public String getTeamChatPrefix() { return teamChatPrefix; }

	public String getGlobalChatPrefix() { return globalChatPrefix; }

	public boolean getDisableMotd() { return disableMotd; }

	public boolean getAnnounceAdvancements() { return announceAdvancements; }

	public Difficulty getGameDifficulty() { return gameDifficulty; }

	public boolean getEnableHealthRegen() { return enableHealthRegen; }

	public boolean getEnableKitsPermissions() { return enableKitsPermissions; }

	public boolean getEnableCraftsPermissions() { return enableCraftsPermissions; }

	public boolean getEnableExtraHalfHearts() { return enableExtraHalfHearts; }

	public int getExtraHalfHearts() { return extraHalfHearts; }

	public boolean getEnableGoldDrops() { return enableGoldDrops; }

	public int getMinGoldDrops() { return minGoldDrops; }

	public int getMaxGoldDrops() { return maxGoldDrops; }

	public List<EntityType> getAffectedGoldDropsMobs() { return affectedGoldDropsMobs; }

	public int getGoldDropPercentage() { return goldDropPercentage; }

	public int getMinimalReadyTeamsToStart() { return minimalReadyTeamsToStart; }

	public int getMaxPlayersPerTeam() { return maxPlayersPerTeam; }

	public boolean getUseTeamColors() { return teamColors; }

	public boolean getChangeDisplayNames() { return changeDisplayNames; }

	public boolean getEnableEpisodeMarkers() { return enableEpisodeMarkers; }

	public long getEpisodeMarkersDelay() { return episodeMarkersDelay; }

	public boolean getEnableScenarioVoting() { return enableScenarioVoting; }

	public int getMaxScenarioVotes() { return maxScenarioVotes; }

	public int getElectedScenaroCount() { return electedScenaroCount; }

	public Set<Scenario> getScenarioBlackList() { return scenarioBlackList; }

	public boolean getEnableExpDropOnDeath() { return enableExpDropOnDeath; }

	public int getExpDropOnDeath() { return expDropOnDeath; }

	public boolean getEnableKillDisconnectedPlayers() { return enableKillDisconnectedPlayers; }

	public int getMaxDisconnectPlayersTime() { return maxDisconnectPlayersTime; }

	public boolean getSpawnOfflinePlayers() { return spawnOfflinePlayers; }

	public boolean getPickRandomWorldFromList() { return pickRandomWorldFromList; }

	public List<String> getWorldsList() { return worldsList; }

	public boolean getEnableBungeeSupport() { return enableBungeeSupport; }

	public boolean getEnableBungeeLobbyItem() { return enableBungeeLobbyItem; }

	public String getServerBungee() { return serverBungee; }

	public long getBorderTimeToShrink() { return borderTimeToShrink; }

	public long getTimeLimit() { return timeLimit; }

	public boolean getEnableTimeLimit() { return enableTimeLimit; }

	public int getMaxBuildingHeight() { return maxBuildingHeight; }

	public boolean getEnableNether() { return enableNether; }

	public boolean getEnableTheEnd() { return enableTheEnd; }

	public boolean getBanLevelTwoPotions() { return banLevelTwoPotions; }

	public boolean getEnableDayNightCycle() { return enableDayNightCycle; }

	public long getTimeBeforePermanentDay() { return timeBeforePermanentDay; }

	public boolean getBorderIsMoving() { return borderIsMoving; }

	public int getBorderStartSize() { return borderStartSize; }

	public int getBorderEndSize() { return borderEndSize; }

	public long getBorderTimeBeforeShrink() { return borderTimeBeforeShrink; }

	public boolean getIsDeathmatchAdvantureMode() { return deathmatchAdvantureMode; }

	public boolean getEnableDeathmatchForceEnd() { return enableDeathmatchForceEnd; }

	public long getDeathmatchForceEndDelay() { return deathmatchForceEndDelay; }

	public Material getArenaTeleportSpotBLock() { return arenaTeleportSpotBLock; }

	public int getDeathmatchStartSize() { return deathmatchStartSize; }

	public int getDeathmatchEndSize() { return deathmatchEndSize; }

	public long getDeathmatchTimeToShrink() { return deathmatchTimeToShrink; }

	public int getTimeBeforeStartWhenReady() { return timeBeforeStartWhenReady; }

	public boolean getRegenHeadDropOnPlayerDeath() { return regenHeadDropOnPlayerDeath; }

	public boolean getEnableDoubleRegenHead() { return doubleRegenHead; }

	public boolean getEnableGoldenHeads() { return enableGoldenHeads; }

	public boolean getPlaceHeadOnFence() { return placeHeadOnFence; }

	public boolean getAllowGhastTearsDrops() { return allowGhastTearsDrops; }

	public Sound getSoundOnPlayerDeath() { return soundOnPlayerDeath; }

	public void setOverworldUuid(String uuid) { overworldUuid = uuid; }

	public void setNetherUuid(String uuid) { netherUuid = uuid; }

	public void setTheEndUuid(String theEndUuid) { this.theEndUuid = theEndUuid; }

	public List<String> getTimeCommands() { return timeCommands; }
