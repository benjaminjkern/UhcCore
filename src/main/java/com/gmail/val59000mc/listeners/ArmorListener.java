...
import com.gmail.val59000mc.events.ArmorType;
import com.gmail.val59000mc.events.ArmorEquipEvent.EquipMethod;
...
public class ArmorListener implements Listener {
    ...
    public ArmorListener() { this.blockedMaterials = new ArrayList<>(); }

    public ArmorListener(List<String> blockedMaterials) { this.blockedMaterials = blockedMaterials; }
    ...
    public void playerInteractEvent(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (!e.useInteractedBlock().equals(Result.DENY)) {
                if (e.getClickedBlock() != null && e.getAction() == Action.RIGHT_CLICK_BLOCK && !player.isSneaking()) {// Having
                                                                                                                       // both
                                                                                                                       // of
                                                                                                                       // these
                                                                                                                       // checks
     ...
     */
    public static boolean isAirOrNull(ItemStack item) { return item == null || item.getType().equals(Material.AIR); }
}