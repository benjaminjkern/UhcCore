...
public class BiomeMapping {
    ...
    public enum Biome {
        OCEAN(0, "ocean", "BiomeOcean"), PLAINS(1, "plains", "BiomePlains"), DESERT(2, "desert", "BiomeDesert"),
        MOUNTAINS(3, "mountains", "BiomeBigHills"), FOREST(4, "forest", "BiomeForest"), TAIGA(5, "taiga", "BiomeTaiga"),
        SWAMP(6, "swamp", "BiomeSwamp"), RIVER(7, "river", "BiomeRiver"), NETHER(8, "nether", "BiomeHell"),
        THE_END(9, "the_end", "BiomeTheEnd"), FROZEN_OCEAN(10, "frozen_ocean", "BiomeFrozenOcean"),
        FROZEN_RIVER(11, "frozen_river", "BiomeFrozenRiver"), SNOWY_TUNDRA(12, "snowy_tundra", "BiomeIcePlains"),
        SNOWY_MOUNTAINS(13, "snowy_mountains", "BiomeIceMountains"),
        MUSHROOM_FIELDS(14, "mushroom_fields", "BiomeMushrooms"),
        MUSHROOM_FIELD_SHORE(15, "mushroom_field_shore", "BiomeMushroomIslandShore"), BEACH(16, "beach", "BiomeBeach"),
        DESERT_HILLS(17, "desert_hills", "BiomeDesertHills"), WOODED_HILLS(18, "wooded_hills", "BiomeForestHills"),
        TAIGA_HILLS(19, "taiga_hills", "BiomeTaigaHills"), MOUNTAIN_EDGE(20, "mountain_edge", "BiomeExtremeHillsEdge"),
        JUNGLE(21, "jungle", "BiomeJungle"), JUNGLE_HILLS(22, "jungle_hills", "BiomeJungleHills"),
        JUNGLE_EDGE(23, "jungle_edge", "BiomeJungleEdge"), DEEP_OCEAN(24, "deep_ocean", "BiomeDeepOcean"),
        STONE_SHORE(25, "stone_shore", "BiomeStoneBeach"), SNOWY_BEACH(26, "snowy_beach", "BiomeColdBeach"),
        BIRCH_FOREST(27, "birch_forest", "BiomeBirchForest"),
        BIRCH_FOREST_HILLS(28, "birch_forest_hills", "BiomeBirchForestHills"),
        DARK_FOREST(29, "dark_forest", "BiomeRoofedForest"), SNOWY_TAIGA(30, "snowy_taiga", "BiomeColdTaiga"),
        ...
        WOODED_MOUNTAINS(34, "wooded_mountains", "BiomeExtremeHillsWithTrees"), SAVANNA(35, "savanna", "BiomeSavanna"),
        SAVANNA_PLATEAU(36, "savanna_plateau", "BiomeSavannaPlateau"), BADLANDS(37, "badlands", "BiomeMesa"),
        ...
        END_BARRENS(43, "end_barrens", "BiomeTheEndBarrenIsland"), WARM_OCEAN(44, "warm_ocean", "BiomeWarmOcean"),
        LUKEWARM_OCEAN(45, "lukewarm_ocean", "BiomeLukewarmOcean"), COLD_OCEAN(46, "cold_ocean", "BiomeColdOcean"),
        ...
        DEEP_FROZEN_OCEAN(50, "deep_frozen_ocean", "BiomeFrozenDeepOcean"), THE_VOID(127, "the_void", "BiomeVoid"),
        ...
        SWAMP_HILLS(134, "swamp_hills", "BiomeSwamplandMutated"), ICE_SPIKES(140, "ice_spikes", "BiomeIcePlainsSpikes"),
    ...
    private static final Biome[] HASH_SET_BIOMES = new Biome[] { Biome.OCEAN, Biome.PLAINS, Biome.DESERT,
            Biome.MOUNTAINS, Biome.FOREST, Biome.TAIGA, Biome.SWAMP, Biome.RIVER, Biome.FROZEN_RIVER,
            Biome.SNOWY_TUNDRA, Biome.SNOWY_MOUNTAINS, Biome.MUSHROOM_FIELDS, Biome.MUSHROOM_FIELD_SHORE, Biome.BEACH,
            Biome.DESERT_HILLS, Biome.WOODED_HILLS, Biome.TAIGA_HILLS, Biome.JUNGLE, Biome.JUNGLE_HILLS,
            Biome.JUNGLE_EDGE, Biome.DEEP_OCEAN, Biome.STONE_SHORE, Biome.SNOWY_BEACH, Biome.BIRCH_FOREST,
            Biome.BIRCH_FOREST_HILLS, Biome.DARK_FOREST, Biome.SNOWY_TAIGA, Biome.SNOWY_TAIGA_HILLS,
            Biome.GIANT_TREE_TAIGA, Biome.GIANT_TREE_TAIGA_HILLS, Biome.WOODED_MOUNTAINS, Biome.SAVANNA,
            Biome.SAVANNA_PLATEAU, Biome.BADLANDS, Biome.WOODED_BADLANDS_PLATEAU, Biome.BADLANDS_PLATEAU };
    ...
    public static void replaceBiomes(Biome oldBiome, Biome newBiome) {
        ...
        try {
            ...
            Object newBiomeBase = registerMethod.invoke(null, oldBiome.getId(), oldBiome.getName(),
                    newBiome.getBiomeBaseInstance());

            oldBiomeField.set(null, newBiomeBase);

            Set<Object> hashSet = (Set<Object>) biomeBaseHashSet.get(null);
            hashSet.clear();
            for (Biome biome : HASH_SET_BIOMES) { hashSet.add(biome.getField().get(null)); }
