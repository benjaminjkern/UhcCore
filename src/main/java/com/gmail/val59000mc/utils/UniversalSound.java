...
public enum UniversalSound {
    BLOCK_NOTE_BLOCK_HARP, CLICK("CLICK", "UI_BUTTON_CLICK", "UI_BUTTON_CLICK"),
    ...
    BLOCK_GRASS_BREAK("DIG_GRASS", "BLOCK_GRASS_BREAK", "BLOCK_GRASS_BREAK"), ITEM_TRIDENT_RIPTIDE_3,
